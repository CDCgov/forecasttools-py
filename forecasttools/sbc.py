...
class SBC:
    def __init__(
        ...
        *args,
        ...
        num_simulations=100,
        sample_kwargs=dict(num_warmup=500, num_samples=10),
    ...
    def _get_prior_predictive_samples(self):
        ...
        observed_values = {k: prior_predictions[v] for k, v in self.observed_vars.items()}
    ...
    #     """
    #     observed_values = self._get_prior_predictive_samples()
    ...
    #             prior_predictive_draw = {k:v[idx] for k, v in observed_values.items()}

    #             posterior = self._get_posterior_samples(sampler_seeds[idx], prior_predictive_draw)
